...
public class UpvoteServiceImpl implements UpvoteService {
	...
	private Upvote getUpvote(User user, Question question, Reply reply) {
		for (Upvote upvote : upvotes) {
			//This is a conditional statement to verify whether the user has
			//already upvoted the question.
			//If he/she has, it will only return that has it been upvoted
			//And therefore will note create another upvote
