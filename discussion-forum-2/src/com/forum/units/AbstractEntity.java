...
public abstract class AbstractEntity {
	 ...
	 */
	// A getter method implemented to retrieve the id of the Abstract Entity
	 ...
	 */
	// A setter method implemented to set/update the current instance's id
	...
	//Since this an abstract method, it cannot be instantiated, but can be implemented
